...
func TestSchema(t *testing.T) {
	...
	assert.Equal(t, V1Alpha1Version, s.Version)
	...
	assert.Equal(t, "DefaultValue", s.Models[8].Enums[0].Default)
	assert.Equal(t, []string{"DefaultValue", "SecondValue", "FirstValue"}, s.Models[8].Enums[0].Values)
	...
	assert.Equal(t, "DefaultValue", s.Models[9].Enums[0].Default)
	assert.Equal(t, []string{"DefaultValue", "SecondValue", "FirstValue"}, s.Models[9].Enums[0].Values)

	assert.Equal(t, "ModelWithEnumAccessor", s.Models[10].Name)
	assert.Equal(t, "EnumField", s.Models[10].Enums[0].Name)
	assert.Equal(t, "DefaultValue", s.Models[10].Enums[0].Default)
	assert.Equal(t, []string{"DefaultValue", "SecondValue", "FirstValue"}, s.Models[10].Enums[0].Values)
	...
	assert.Equal(t, "DefaultValue", s.Models[11].Enums[0].Default)
	assert.Equal(t, []string{"DefaultValue", "SecondValue", "FirstValue"}, s.Models[11].Enums[0].Values)
	...
	assert.Equal(t, "Float32MapField", s.Models[18].Float32Maps[0].Name)
	assert.Equal(t, "float32", s.Models[18].Float32Maps[0].Value)
	assert.Equal(t, "Float32MapFieldEmbedded", s.Models[18].Float32Maps[1].Name)
	assert.Equal(t, "EmptyModel", s.Models[18].Float32Maps[1].Value)
	...
	assert.Equal(t, "Float64MapField", s.Models[18].Float64Maps[0].Name)
	assert.Equal(t, "float64", s.Models[18].Float64Maps[0].Value)
	assert.Equal(t, "Float64MapFieldEmbedded", s.Models[18].Float64Maps[1].Name)
	assert.Equal(t, "EmptyModel", s.Models[18].Float64Maps[1].Value)
	...
	assert.Equal(t, "DefaultValue", s.Models[18].Enums[0].Default)
	assert.Equal(t, []string{"DefaultValue", "SecondValue", "FirstValue"}, s.Models[18].Enums[0].Values)
	assert.Equal(t, "EnumArrayField", s.Models[18].EnumArrays[0].Name)
	assert.Equal(t, []string{"FirstValue", "SecondValue"}, s.Models[18].EnumArrays[0].Values)
	assert.Equal(t, uint32(0), s.Models[18].EnumArrays[0].InitialSize)
	assert.Equal(t, "EnumMapField", s.Models[18].EnumMaps[0].Name)
	assert.Equal(t, []string{"FirstValue", "SecondValue"}, s.Models[18].EnumMaps[0].Values)
	assert.Equal(t, "string", s.Models[18].EnumMaps[0].Value)
	assert.Equal(t, "EnumMapFieldEmbedded", s.Models[18].EnumMaps[1].Name)
	assert.Equal(t, []string{"FirstValue", "SecondValue"}, s.Models[18].EnumMaps[1].Values)
